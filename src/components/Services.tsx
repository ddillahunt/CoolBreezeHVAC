          ...
          {services.slice(0, 3).map((s) => {
            ...
            return (
              <Link
                key={s.slug}
                to={`/services/${s.slug}`}
                className="group bg-light-gray hover:bg-white rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-navy/5 border border-transparent hover:border-medium-gray"
              >
                {image && (
